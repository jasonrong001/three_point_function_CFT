...
\end{figure}
The error bars for $N=10^4$ are about $\sqrt{10}$ smaller than for $N=10^3$, as expected.\footnote{For example, the last point in the left (right) plot is $0.525\pm0.018$ ($0.534\pm0.006$).} As $N\to\infty$, the result is seen to converge to the DMRG result from Fig.~\ref{fig:sigma-sigma}, which for large $x$ agrees with the CFT result (blue solid line).
