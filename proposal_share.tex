...
\begin{figure}[htbp]
\centering
\includegraphics[scale=0.7]{phase_diagram_SSF_LR.png}
...
The critical energy gap of the dimensionless Hamiltonian $\hat H$ is $E_{\rm gap} = E_1-E_0=0.00327$ for $L=40$, in our DRMG simulations. \junchen{At the tip of the parabola, we get $E_{\rm gap} = E_1-E_0=0.0094713$. Deeply in the disordered phase, we get $E_{\rm gap}$ of order 1.} The physical energy gap is therefore this times $C_6/a^6$, i.e.
\beq
