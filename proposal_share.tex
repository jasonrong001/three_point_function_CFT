...
One important quantity below is the gap of the quantum spin chain. The critical energy gap is $E_{\rm gap} = E_1-E_0=0.00327$ for $L=40$ in dimensionless units. In our DRMG simulations we set $C_6/a^6=1$. Using the physical value of $C_6/a^6$ we get in physical units 
\beq
