...
The critical energy gap of the dimensionless Hamiltonian $\hat H$ is $E_{\rm gap} = E_1-E_0=0.00327$ for $L=40$, in our DRMG simulations. The physical energy gap is therefore this times $C_6/a^6$, i.e.
\beq
