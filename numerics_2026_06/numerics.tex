...
\caption{The correlation function $|\langle Z_x \rangle|$. The blue and red dots corresponds to $\Delta'_1=\Delta'_N=1.01734$ (uniform $\Delta'$) and $\Delta'_1=\Delta'_N=5$ respectively. The black dashed line is $\frac{0.88}{|x_L|^{1/8}}$.} 
\label{Z1pt}
\end{figure}
