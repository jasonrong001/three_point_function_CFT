...
\junchen{If we tune the boundary $\Delta'$, we probably can reach the free boundary condition, and measure bulk-boundary correlator as we initially planned. But do we want to tune one extra parameter.}
